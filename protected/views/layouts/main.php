	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Content', 'url'=>array('/admin/articles'), 'visible'=>!Yii::app()->user->isGuest, 'items'=>array(
					 array('label'=>'Articles', 'url'=>array('/admin/articles'), 'items' => array(
						 array('label'=>'Articles', 'url'=>array('/admin/articles')),
